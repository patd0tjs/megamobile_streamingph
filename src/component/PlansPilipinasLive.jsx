...
const PlansPilipinasLive = (props) => {
  const plansPilipinasLiveData = props.plansData;
  ...
  const handlePriceAction = (duration, type, price, vendor) => {
    setVendor("pilipinas-live");
    setVendorImage(Assets.PILIPINASLIVE);
    setOrigin("plans");
...
export default PlansPilipinasLive;
